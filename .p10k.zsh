# Generated by Powerlevel10k configuration wizard on 2020-08-06 at 21:03 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 15764.
# Wizard options: ascii, rainbow, 24h time, 2 lines, dotted, dark-ornaments, sparse,
# concise.
...
typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(status dir newline prompt_char)
typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(command_execution_time context time newline)
...
typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=70 #180 #3
